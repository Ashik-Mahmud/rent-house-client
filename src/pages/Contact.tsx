  ...
  return (
    <section>
      <div className="container mx-auto py-10 text-center">
        <section className="text-gray-600 body-font relative bg-white rounded shadow pb-10">
          <div className="container px-5 py-2 mx-auto">
            <section className="text-gray-600 body-font">
              <div className="container px-5 py-24 mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 -m-4 gap-4">
